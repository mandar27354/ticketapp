...
function App() {
  ...
  async function datas() {
    ...
    let data2 = parseInt(res.data);
    setdata(data2);
    console.log( "hii",data);

    if (data == parseInt(price) + parseInt(collection)) {
      setfetchres(true);
    }
  }
  ...
  // let time1 = d.getHours();
  // let time2 = d.getMinutes();
  // let time3 = d.getSeconds();
      ...
      <div className="bg-gray-600 w-[500px] h-80 m-auto  flex flex-col rounded-xl px-4">
        ...
        <div className="mt-5">
          <div className="flex flex-row justify-between">
            ...
            {fetchres && data == parseInt(price) + parseInt(collection) ? (
              <button
                className="btn-primary px-2 py-1 rounded-lg"
